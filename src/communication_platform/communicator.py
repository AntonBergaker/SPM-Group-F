...
class Communicator:
    ...
    def _start_ai_vs_ai(self, match):
        ...
        """
        white_player, black_player = match
        wd = white_player.get_difficulty()
        bd = black_player.get_difficulty()
        if wd > bd:
            # White player difficulty is higher, wins
            self._match_ended(white_player)
        elif bd > wd:
            # Black player difficulty is higher, wins
            self._match_ended(black_player)
        else:
            # Difficulty equal, random winner
            self._match_ended(random.choice((white_player, black_player)))
    ...
    def _start_ai_vs_host(self, match):
        ...
        # TODO start AI vs host
        # TODO remove demo code
        print('Starting AI vs host')
        self._randomize_game_result_demo(white_ai, black_host)
    ...
    def _start_host_vs_ai(self, match):
        ...
        # TODO start host vs AI
        # TODO remove demo code
        print('Starting host vs AI')
        self._randomize_game_result_demo(white_host, black_ai)
    ...
    def _start_ai_vs_player(self, match):
        ...
        # TODO start AI vs player
        # TODO remove demo code
        self._randomize_game_result_demo(white_ai, black_player)
